...
- 生成先: `output/model_experiments/onizuka_fire_motion/`
...
モデルを追加したいときは `experiments/onizuka_fire_motion/experiment_config.json` の `models` に名前を足して、同じコマンドをもう一度実行してください。
